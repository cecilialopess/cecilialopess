...
- 🎓 Estudante de **Análise e Desenvolvimento de Sistemas** na **CESAR School** (Bolsista Integral — Programa Embarque Digital)
- 🚀 Participante da **Residência Tecnológica do Porto Digital**, desenvolvendo projetos reais para empresas parceiras
- 🔭 Trabalhando atualmente em **Python**, **JavaScript/TypeScript** e automação low-code (ServiceNow)
- 🌱 Estudando fundamentos de nuvem para a certificação **AWS Certified Cloud Practitioner**
- 📍 Recife, PE
...
**Jovem Aprendiz — Administrativo de Marketing**
Cadan (Qualificação SENAC em Téc. Administração)
`Organização de Processos` `Suporte Administrativo`

---

## 🏆 Conquistas e Projetos

### Finalista do DemoDay | [CODEX](https://github.com/cecilialopess/CODEX)
Residência Tecnológica Porto Digital (Kick Off 2025.2) — protótipo de interface no Figma para um projeto com o tema "Tecnologia e Inovação a Serviço da Educação".

![Finalista](https://img.shields.io/badge/🏅-Finalista_DemoDay-FFD700?style=flat-square)
![Evento](https://img.shields.io/badge/Evento-Kick_Off_2025.2-6F42C1?style=flat-square)
![Ferramenta](https://img.shields.io/badge/Design-Figma-F24E1E?style=flat-square)
...
### Equipe selecionada | Maratona de Inovação Territorial — Recife Resolve
Iniciativa da Prefeitura do Recife, em parceria com a CESAR School e apoio do UK-Brazil Tech Hub. Equipe classificada, após o ideathon, para a Residência Tecnológica.

![Selecionada](https://img.shields.io/badge/🏅-Equipe_Selecionada-FFD700?style=flat-square)
...
![AWS](https://img.shields.io/badge/AWS_Cloud_Practitioner-Em_andamento-FF9900?style=flat-square&logo=amazonaws&logoColor=white)
![Python](https://img.shields.io/badge/Python-CESAR_School-3776AB?style=flat-square&logo=python&logoColor=white)
![C](https://img.shields.io/badge/Linguagem_C-CESAR_School-00599C?style=flat-square&logo=c&logoColor=white)
![RiseUp](https://img.shields.io/badge/Ciclo_RiseUp-Rocketseat-8257E5?style=flat-square)
